...
module Templates.QuickGtk.Scaffolder
  ( scaffold,
    writeFileWithInfo,
    ensureDir,
  )
...
import Templates.QuickGtk.TemplateFiles
...
scaffold targetDir = do
  ...
  let stripTemplatePrefix rel =
        case stripPrefix ("templates/" ++ "QuickGtk" ++ "/") rel of
      ...
      fileTemplates = Templates.QuickGtk.TemplateFiles.templates
